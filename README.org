...
* emacsite -- easy [[https://www.gnu.org/software/emacs/][Emacs]] web sites
** Features
...
** Quick start
To create https://github.com/ ~myname/mysite~:
| Clone   | ~git clone https://github.com/myglc2/emacsite.git mysite && cd $_ && make repo~ |
| Start   | ~make start~                                                                    |
| Build   | ~make~                                                                          |
...
A: Sometimes GitHub fails to post the site. Try pushing it again with
~touch index.org && make gh~
